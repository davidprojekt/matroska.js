...
//!
//! Usage: `cargo run -p matroska-remux --example dump_segments -- <file.mkv> <out_dir> [track]`
//!
...
use matroska_ebml::ebml::Ebml;
use matroska_ebml::fs_source::FsSource;
use matroska_ebml::matroska_data::element_id_type_map;
use matroska_remux::player::Demuxer;
use std::fs;
use std::path::Path;
