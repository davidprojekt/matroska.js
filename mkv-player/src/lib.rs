...
//!
//! Builds on the `matroska-ebml` parser crate: it consumes the EBML/Matroska reader and
...
//! (`matroska-ebml`, `ebml-schema`) is MIT-licensed and can be used independently.
