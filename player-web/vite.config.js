...
// The transcoding code (and the ffmpeg stub used to strip it) now lives in @matroska-js/player.
...
export default defineConfig({
  ...
  // @matroska-js/remux out of esbuild's dep pre-bundling preserves that reference so Vite
  ...
  optimizeDeps: {
    ...
    // NB: jassub is a direct dependency of this app (not only of @matroska-js/player) so npm
